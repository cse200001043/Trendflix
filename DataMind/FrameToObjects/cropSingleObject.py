...
def cropSingleObject():
    inputPath = "FrameToObjects/RemovedBackground/output0.png"
    outputPath = "FrameToObjects/Object/output0.png"

    input_image = cv2.imread(inputPath, cv2.IMREAD_UNCHANGED)
